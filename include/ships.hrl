...
-record(fitted_ship, {ref, ship_frame, guns, launchers, equips,
    upgrades} ).

-record(ship_in_space, {ref, ship_pid, fitted_ship, current_heading, current_velocity, set_heading, set_velocity} ).
